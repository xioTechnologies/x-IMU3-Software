                                                                                                                                           ...
                                                                                                                                           connectionPanelContainer(connectionPanelContainer_)
{
    ...
    availableConnectionsButton.onClick = [this]
    {
        ...
        {
            existingConnections.push_back({connectionPanel->getDescriptor(), connectionPanel->getConnection()->getType(), std::shared_ptr<ximu3::ConnectionInfo>(connectionPanel->getConnection()->getInfo().release())});
        }
