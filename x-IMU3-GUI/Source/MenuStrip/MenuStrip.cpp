...
juce::PopupMenu MenuStrip::getWindowMenu() const
{
    ...
    addWindowItem(WindowIDs::GyroscopeGraph);
    addWindowItem(WindowIDs::AccelerometerGraph);
    addWindowItem(WindowIDs::MagnetometerGraph);
    addWindowItem(WindowIDs::EulerAnglesGraph);
    addWindowItem(WindowIDs::LinearAccelerationGraph);
    addWindowItem(WindowIDs::EarthAccelerationGraph);
    addWindowItem(WindowIDs::HighGAccelerometerGraph);
    addWindowItem(WindowIDs::TemperatureGraph);
    addWindowItem(WindowIDs::BatteryPercentageGraph);
    addWindowItem(WindowIDs::BatteryVoltageGraph);
    addWindowItem(WindowIDs::RssiPercentageGraph);
    addWindowItem(WindowIDs::RssiPowerGraph);
    addWindowItem(WindowIDs::SerialAccessoryGraph);
    addWindowItem(WindowIDs::ReceivedMessageRateGraph);
    addWindowItem(WindowIDs::ReceivedDataRateGraph);
...
juce::PopupMenu MenuStrip::getWindowLayoutMenu()
{
    ...
    addSingleWindowItem(WindowIDs::GyroscopeGraph);
    addSingleWindowItem(WindowIDs::AccelerometerGraph);
    addSingleWindowItem(WindowIDs::MagnetometerGraph);
    addSingleWindowItem(WindowIDs::EulerAnglesGraph);
    addSingleWindowItem(WindowIDs::LinearAccelerationGraph);
    addSingleWindowItem(WindowIDs::EarthAccelerationGraph);
    addSingleWindowItem(WindowIDs::HighGAccelerometerGraph);
    addSingleWindowItem(WindowIDs::TemperatureGraph);
    addSingleWindowItem(WindowIDs::BatteryPercentageGraph);
    addSingleWindowItem(WindowIDs::BatteryVoltageGraph);
    addSingleWindowItem(WindowIDs::RssiPercentageGraph);
    addSingleWindowItem(WindowIDs::RssiPowerGraph);
    addSingleWindowItem(WindowIDs::SerialAccessoryGraph);
    addSingleWindowItem(WindowIDs::ReceivedMessageRateGraph);
    addSingleWindowItem(WindowIDs::ReceivedDataRateGraph);
        ...
        windowLayout_ = { WindowIDs::Row, {},
                          {
                                  ...
                                  { WindowIDs::Column, {}, {
                                          { WindowIDs::Row, {}, {
                                                  { WindowIDs::GyroscopeGraph, {}},
                                                  { WindowIDs::AccelerometerGraph, {}},
                                                  { WindowIDs::MagnetometerGraph, {}},
                                                  { WindowIDs::HighGAccelerometerGraph, {}},
                                          }},
                                          { WindowIDs::Row, {}, {
                                                  { WindowIDs::EulerAnglesGraph, {{ WindowIDs::size, 1 }}},
