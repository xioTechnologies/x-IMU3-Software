...
private:
    ...
    IconButton readAllFailedButton { IconButton::Style::normal, BinaryData::download_warning_svg, 1.0f, "Read Settings from Device" };
    IconButton writeAllButton { IconButton::Style::normal, BinaryData::upload_svg, 1.0f, "Write Settings to Device" };
    IconButton writeAllFailedButton { IconButton::Style::normal, BinaryData::upload_warning_svg, 1.0f, "Write Settings to Device" };
