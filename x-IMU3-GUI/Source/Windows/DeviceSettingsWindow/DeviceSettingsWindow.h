...
private:
    ...
    void showInfo(const juce::String &heading, const juce::String &message = "");

    void syncSettings();

    void loadSchema(const Schema &schema);

    void loadSchema(std::unique_ptr<SettingsSchema::Group> group);
