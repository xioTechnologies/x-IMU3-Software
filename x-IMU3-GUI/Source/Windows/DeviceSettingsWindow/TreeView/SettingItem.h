...
public:
    SettingItem(SettingsSchema::Setting &setting_, SettingsSchema::Setting *const dependsOn_, std::function<void(SettingsSchema::Setting &setting, const std::string &command)> write_, std::function<bool()> hideUnusedSettings_)
...
private:
    ...
    const std::function<void(SettingsSchema::Setting &setting, const std::string &command)> write;
