...
public:
    ...
    ItemComponent(const SettingsSchema::Item &item_, const juce::String &name, std::unique_ptr<juce::Component> value_) : item(item_), nameLabel(name), value(std::move(value_)) {
