...
Window::Window(DevicePanel& devicePanel_, const juce::ValueTree& windowLayout, const juce::Identifier& type_, const juce::String& menuButtonTooltip, std::function<juce::PopupMenu()> getPopup)
