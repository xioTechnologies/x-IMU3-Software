// This file is modified from https://github.com/juce-framework/JUCE/blob/master/examples/CMake/GuiApp/Main.cpp
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(xIMU3GUIApplication)
};
