...
void Text::setColour(const juce::Colour& colour_)
{
    colour = colour_;
}
...
void Text::render(GLResources& resources)
{
    ...
    for (size_t index = 0; index < (size_t) text.length(); index++)
    {
        ...
        GLfloat colors[] = { colour.getFloatRed(), colour.getFloatGreen(), colour.getFloatBlue(), 1.0f,
                             colour.getFloatRed(), colour.getFloatGreen(), colour.getFloatBlue(), 1.0f,
                             colour.getFloatRed(), colour.getFloatGreen(), colour.getFloatBlue(), 1.0f,
                             colour.getFloatRed(), colour.getFloatGreen(), colour.getFloatBlue(), 1.0f };
        ...
        resources.textBuffer.linkVbo(resources.textShader.colourIn.attributeID, Buffer::colourBuffer, Buffer::Rgba, Buffer::floatingPoint);
        ...
        resources.textBuffer.fillVbo(Buffer::colourBuffer, colors, sizeof(colors), Buffer::multipleFill);
