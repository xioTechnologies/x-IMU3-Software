...
impl DataMessage for InertialMessage {
    ...
    fn parse_binary(message: &[u8]) -> Result<Self, DecodeError> {
        ...
        Ok(Self {
            ...
            gyroscope_z: binary_message.gyroscope_z,
            accelerometer_x: binary_message.accelerometer_x,
            accelerometer_y: binary_message.accelerometer_y,
            accelerometer_z: binary_message.accelerometer_z,
        })
    }
