...
#[no_mangle]
pub extern "C" fn XIMU3_keep_open_state_to_string(state: KeepOpenState) -> *const c_char {
    str_to_char_ptr(&state.to_string())
}

#[no_mangle]
pub extern "C" fn XIMU3_keep_open_new(connection: *mut Connection, callback: Callback<KeepOpenState>, context: *mut c_void) -> *mut KeepOpen<'static> {
