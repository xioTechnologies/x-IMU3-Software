...
namespace ximu3 {
    ...
    public:
        ...
        XIMU3_ConnectionStatus getStatus() {
            return XIMU3_connection_get_status(wrapped);
        }
        ...
        std::optional<XIMU3_PingResponse> getPingResponse() {
            return toOptional(XIMU3_connection_get_ping_response(wrapped));
        }
        ...
        uint64_t addStatusCallback(std::function<void(XIMU3_ConnectionStatus)> &callback) {
            return XIMU3_connection_add_status_callback(wrapped, Helpers::wrapCallable<XIMU3_ConnectionStatus>(callback), &callback);
        }
        ...
        uint64_t addPingCallback(std::function<void(XIMU3_PingResponse)> &callback) {
            return XIMU3_connection_add_ping_callback(wrapped, Helpers::wrapCallable<XIMU3_PingResponse>(callback), &callback);
        }

        // Start of code block #0 generated by x-IMU3-API/Rust/src/data_messages/generate_data_messages.py

        std::optional<XIMU3_InertialMessage> getInertialMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_inertial_message(wrapped, consume);
        ...
        std::optional<XIMU3_MagnetometerMessage> getMagnetometerMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_magnetometer_message(wrapped, consume);
        ...
        std::optional<XIMU3_HighGAccelerometerMessage> getHighGAccelerometerMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_high_g_accelerometer_message(wrapped, consume);
        ...
        std::optional<XIMU3_QuaternionMessage> getQuaternionMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_quaternion_message(wrapped, consume);
        ...
        std::optional<XIMU3_RotationMatrixMessage> getRotationMatrixMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_rotation_matrix_message(wrapped, consume);
        ...
        std::optional<XIMU3_EulerAnglesMessage> getEulerAnglesMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_euler_angles_message(wrapped, consume);
        ...
        std::optional<XIMU3_LinearAccelerationMessage> getLinearAccelerationMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_linear_acceleration_message(wrapped, consume);
        ...
        std::optional<XIMU3_EarthAccelerationMessage> getEarthAccelerationMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_earth_acceleration_message(wrapped, consume);
        ...
        std::optional<XIMU3_AhrsStatusMessage> getAhrsStatusMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_ahrs_status_message(wrapped, consume);
        ...
        std::optional<XIMU3_SerialAccessoryMessage> getSerialAccessoryMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_serial_accessory_message(wrapped, consume);
        ...
        std::optional<XIMU3_SyncMessage> getSyncMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_sync_message(wrapped, consume);
        ...
        std::optional<XIMU3_LtcMessage> getLtcMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_ltc_message(wrapped, consume);
        ...
        std::optional<XIMU3_TemperatureMessage> getTemperatureMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_temperature_message(wrapped, consume);
        ...
        std::optional<XIMU3_BatteryMessage> getBatteryMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_battery_message(wrapped, consume);
        ...
        std::optional<XIMU3_RssiMessage> getRssiMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_rssi_message(wrapped, consume);
        ...
        std::optional<XIMU3_ButtonMessage> getButtonMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_button_message(wrapped, consume);
        ...
        std::optional<XIMU3_NotificationMessage> getNotificationMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_notification_message(wrapped, consume);
        ...
        std::optional<XIMU3_ErrorMessage> getErrorMessage(bool consume = false) {
            const auto message = XIMU3_connection_get_error_message(wrapped, consume);
        ...
        void removeCallback(const uint64_t id) {
            XIMU3_connection_remove_callback(wrapped, id);
        }
