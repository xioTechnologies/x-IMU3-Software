...
namespace ximu3 {
    ...
    public:
        ...
        XIMU3_InertialMessage getInertialMessage(bool consume = false) {
            return XIMU3_connection_get_inertial_message(wrapped, consume);
        }

        XIMU3_MagnetometerMessage getMagnetometerMessage(bool consume = false) {
        ...
        XIMU3_RotationMatrixMessage getRotationMatrixMessage(bool consume = false) {
            return XIMU3_connection_get_rotation_matrix_message(wrapped, consume);
        }

        XIMU3_EulerAnglesMessage getEulerAnglesMessage(bool consume = false) {
            return XIMU3_connection_get_euler_angles_message(wrapped, consume);
        }

        XIMU3_LinearAccelerationMessage getLinearAccelerationMessage(bool consume = false) {
            return XIMU3_connection_get_linear_acceleration_message(wrapped, consume);
        }

        XIMU3_EarthAccelerationMessage getEarthAccelerationMessage(bool consume = false) {
            return XIMU3_connection_get_earth_acceleration_message(wrapped, consume);
        }

        XIMU3_AhrsStatusMessage getAhrsStatusMessage(bool consume = false) {
        ...
        XIMU3_TemperatureMessage getTemperatureMessage(bool consume = false) {
            return XIMU3_connection_get_temperature_message(wrapped, consume);
        }

        XIMU3_BatteryMessage getBatteryMessage(bool consume = false) {
            return XIMU3_connection_get_battery_message(wrapped, consume);
        }
        ...
        XIMU3_ErrorMessage getErrorMessage(bool consume = false) {
            return XIMU3_connection_get_error_message(wrapped, consume);
        }
