...
namespace Ximu3
{
    public static class CApi
    {
        ...
        {
            XIMU3_ResultOk,
            XIMU3_ResultAddrInUse,
            XIMU3_ResultAddrNotAvailable,
            XIMU3_ResultAlreadyExists,
            XIMU3_ResultArgumentListTooLong,
            XIMU3_ResultBrokenPipe,
            XIMU3_ResultConnectionAborted,
            XIMU3_ResultConnectionRefused,
            XIMU3_ResultConnectionReset,
            XIMU3_ResultDeadlock,
            XIMU3_ResultDirectoryNotEmpty,
            XIMU3_ResultExecutableFileBusy,
            XIMU3_ResultFileTooLarge,
            XIMU3_ResultHostUnreachable,
            XIMU3_ResultInterrupted,
            XIMU3_ResultInvalidData,
            XIMU3_ResultInvalidInput,
            XIMU3_ResultIsADirectory,
            XIMU3_ResultNetworkDown,
            XIMU3_ResultNetworkUnreachable,
            XIMU3_ResultNotADirectory,
            XIMU3_ResultNotConnected,
            XIMU3_ResultNotFound,
            XIMU3_ResultNotSeekable,
            XIMU3_ResultOther,
            XIMU3_ResultOutOfMemory,
            XIMU3_ResultPermissionDenied,
            XIMU3_ResultReadOnlyFilesystem,
            XIMU3_ResultResourceBusy,
            XIMU3_ResultStaleNetworkFileHandle,
            XIMU3_ResultStorageFull,
            XIMU3_ResultTimedOut,
            XIMU3_ResultTooManyLinks,
            XIMU3_ResultUnexpectedEof,
            XIMU3_ResultUnsupported,
