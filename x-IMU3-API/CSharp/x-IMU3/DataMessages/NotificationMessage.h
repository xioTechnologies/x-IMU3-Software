...
namespace Ximu3
{
    public ref class NotificationMessage
    {
    internal:
        NotificationMessage(ximu3::XIMU3_NotificationMessage message) : message{ new ximu3::XIMU3_NotificationMessage{message} }
        {
        }
    ...
    public:
        ...
        {
            return gcnew String(ximu3::XIMU3_notification_message_to_string(*message));
        }

    private:
        ximu3::XIMU3_NotificationMessage* message;
    };
}
