...
typedef struct XIMU3_CommandMessage
{
    ...
    char terminated_json[XIMU3_CHAR_ARRAY_SIZE];
    char key[XIMU3_CHAR_ARRAY_SIZE];
    char value[XIMU3_CHAR_ARRAY_SIZE];
    char error_response[XIMU3_CHAR_ARRAY_SIZE];
...
struct XIMU3_CommandMessage XIMU3_command_message_from_json(const char *json);
