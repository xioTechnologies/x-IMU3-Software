...
class Connection:
    ...
    def ping(self, retries: int = ..., timeout: int = ...) -> PingResponse | None: ...
    def ping_async(self, callback: Callable[[PingResponse | None], None], retries: int = ..., timeout: int = ...) -> Connection: ...
