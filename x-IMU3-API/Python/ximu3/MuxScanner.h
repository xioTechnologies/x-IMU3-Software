...
static PyObject *mux_scanner_scan(PyObject *null, PyObject *args, PyObject *kwds) {
    PyObject *connection;
    unsigned long number_of_channels = XIMU3_MAX_NUMBER_OF_MUX_CHANNELS;
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!|kkk", kwlist, &connection_object, &connection, &number_of_channels, &retries, &timeout) == 0) {
        return NULL;
    }
