...
PyMODINIT_FUNC PyInit_ximu3() {
    ...
    if (module != NULL &&
        ...
        add_object(module, &sync_message_object, "SyncMessage") &&
        add_object(module, &ltc_message_object, "LtcMessage") &&
        ...
        add_object(module, &button_message_object, "ButtonMessage") &&
        ...
        add_object(module, &mux_scanner_object, "MuxScanner") &&
