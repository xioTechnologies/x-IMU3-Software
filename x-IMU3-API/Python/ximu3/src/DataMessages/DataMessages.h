...
static PyObject *quaternion_message_to_euler_angles_message(QuaternionMessage *self, PyObject *args) {
    const XIMU3_EulerAnglesMessage message = XIMU3_quaternion_message_to_euler_angles_message(self->wrapped);
...
static PyObject *rotation_matrix_message_to_euler_angles_message(RotationMatrixMessage *self, PyObject *args) {
    const XIMU3_EulerAnglesMessage message = XIMU3_rotation_matrix_message_to_euler_angles_message(self->wrapped);

    return euler_angles_message_from(&message);
}

static PyObject *euler_angles_message_to_quaternion_message(EulerAnglesMessage *self, PyObject *args) {
    const XIMU3_QuaternionMessage message = XIMU3_euler_angles_message_to_quaternion_message(self->wrapped);
