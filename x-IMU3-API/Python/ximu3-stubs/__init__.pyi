...
class Connection:
    ...
    def send_command_async(self, commands: str, retries: int, timeout: int, callback: Callable[[CommandMessage | None], None]) -> None: ...
    def send_commands_async(self, commands: Sequence[str], retries: int, timeout: int, callback: Callable[[list[CommandMessage | None]], None]) -> None: ...
