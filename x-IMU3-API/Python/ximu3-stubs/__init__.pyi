...
class Connection:
    def __init__(
        self,
        connection_info: UsbConnectionInfo | SerialConnectionInfo | TcpConnectionInfo | UdpConnectionInfo | BluetoothConnectionInfo | FileConnectionInfo | MuxConnectionInfo,
    ) -> None: ...
    def open(self) -> None: ...
...
# mux_connection_info_object
class MuxConnectionInfo:
