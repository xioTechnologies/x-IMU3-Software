...
class Connection:
    ...
    def send_commands(self, commands: list[str], retries: int, timeout: int) -> list[str]: ...
    def send_commands_async(self, commands: list[str], retries: int, timeout: int, callback: Callable[[list[str]], None]) -> None: ...
...
# data_logger_object
class DataLogger:
    def __init__(self, destination: str, name: str, connections: list[Connection]) -> None: ...
    def get_result(self) -> int: ...
    @staticmethod
    def log(destination: str, name: str, connections: list[Connection], seconds: int) -> int: ...

# file_converter_object
class FileConverter:
    def __init__(self, destination: str, name: str, files: list[str], callback: Callable[[FileConverterProgress], None]) -> None: ...
    @staticmethod
    def convert(destination: str, name: str, files: list[str]) -> FileConverterProgress: ...
