...
static PyObject* connection_add_high_g_callback(Connection* self, PyObject* args)
{
    PyObject* callable;
    ...
    return Py_BuildValue("K", XIMU3_connection_add_high_g_callback(self->connection, high_g_message_callback, callable));
}
...
static PyObject* connection_add_serial_callback(Connection* self, PyObject* args)
{
    PyObject* callable;
    ...
    return Py_BuildValue("K", XIMU3_connection_add_serial_callback(self->connection, serial_message_callback, callable));
}
...
static PyMethodDef connection_methods[] = {
        ...
        { "add_high_g_callback",              (PyCFunction) connection_add_high_g_callback,              METH_VARARGS, "" },
        ...
        { "add_serial_callback",              (PyCFunction) connection_add_serial_callback,              METH_VARARGS, "" },
